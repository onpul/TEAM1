	...
	<div style="background-color: pink">	
		...
		<form class="form-horizontal" id="form" action="EvaluationInsert.jsp" method="get">
			<div>
				...
				<br />
				<div id="allCheckDiv">
					<input type="checkbox" name="check" value="ch1" id="ch1"><label for="ch1">사과1</label>
					<input type="checkbox" name="check" value="ch2" id="ch2"><label for="ch2">철수1</label>
					<input type="checkbox" name="check" value="ch3" id="ch3"><label for="ch3">바나나1</label>
					<input type="checkbox" name="check" value="ch4" id="ch4"><label for="ch4">영희1</label>
				</div>
			</div>
			
			<div>
				<label>방장은 출석하였나요?<input type="checkbox" name="leaderCheck" id=leaderCheck" checked="checked"></label>
			</div>
