...
SELECT R.RIDING_ID, R.LEADER_ID, R.STEP_ID, R.SPEED_ID, R.MOOD_P_ID, R.DINING_P_ID
     , R.EAT_P_ID, R.AGE_P_ID, R.SEX_P_ID, R.E_GRADE_ID, R.RIDING_NAME, R.START_DATE
     ...
     , R.END_LATI, R.END_LONGI, R.END_ADDRESS, R.DETAIL_ADDRESS, R.CONFIRM_DATE, R.COMMENTS
