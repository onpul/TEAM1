...
<head>
<meta charset="UTF-8">
<title>Man_plsModFacility.jsp</title>
...
$(function() {
	$("#look").click(function() {
			...
			window.open("MPDF.jsp", "width=1000, height=400, left=400, top=50"); 
		});
	});
...
$(function() {
	$("#clsBtn").click(function() {
			...
			window.open("Man_ModCount.jsp", "width=1000, height=400, left=400, top=50"); 
