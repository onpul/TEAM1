...
<script type="text/javascript">
	...
	function showPopup()
	{
		window.open("Man_PlsModFacility.jsp", "편의시설생성요청조회", "width=1000, height=400, left=400, top=50"); 
	}
	function showPopup2()
	{
...
<hr />
	...
	<a href="Man_plsModFacility.jsp" id="clsBtn" >·  수정 요청 [ 1 ]</a>
